...
import com.example.bottomnav_ticketbooking.databinding.FragmentTicketBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding){
            btnOrder.setOnClickListener {
                val order = TicketFragmentDirections.actionTicketFragmentToOrderTicketFragment()
